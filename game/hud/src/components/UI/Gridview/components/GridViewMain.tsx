  ...
  */
  ...
  private onColumnReorderBegin = (event: React.MouseEvent<HTMLDivElement>, columnIndex: number) => {
    ...
    if (!this.columnResizing && this.props.reorderableColumns) {
      ...
      this.containerLeft = this.containerRef.getBoundingClientRect().left;
      ...
      this.placeColumn(this.reorderColumnRef, top, left - this.containerLeft, width, columnHeight);
  ...
  private onColumnReorder = (event: MouseEvent) => {
    ...
    ro.mousePosition = event.pageX;
    this.reorderColumnRef.style.left = (columnPositionLeft - this.containerLeft) + 'px';
  }
